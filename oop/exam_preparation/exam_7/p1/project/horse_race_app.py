...
class HorseRaceApp:
    ...
    @staticmethod
    def _fetch_object_by_key_value(collection, key, value):
        obj = next((obj for obj in collection if getattr(obj, key, None) == value), None)
        if obj:
            return obj

    def _validate_horse(self, collection, key, value):
        if self.find_object_by_key_value(collection, key, value):
            raise Exception(f"Horse {value} has been already added!")

    def _validate_jockey(self, collection, key, value):
        if self.find_object_by_key_value(collection, key, value):
            raise Exception(f"Jockey {value} has been already added!")

    def _validate_horse_race(self, collection, key, value):
        if self.find_object_by_key_value(collection, key, value):
            raise Exception(f"Race {value} has been already created!")

    def _validate_add_horse_to_jockey(self, jockey_name: str, horse_type: str):
        jockey = self._fetch_object_by_key_value(self.jockeys, 'name', jockey_name)
    ...
    def _validate_add_jockey_to_horse_race(self, race_type: str, jockey_name: str):
        horse_race = self._fetch_object_by_key_value(self.horse_races, 'race_type', race_type)
        jockey = self._fetch_object_by_key_value(self.jockeys, 'name', jockey_name)
        if not horse_race:
    ...
    def _validate_start_horse_race(self, race_type: str):
        horse_race = self._fetch_object_by_key_value(self.horse_races, 'race_type', race_type)
        if not horse_race:
            raise Exception(f"Race {race_type} could not be found!")
    ...
    def add_horse(self, horse_type: str, horse_name: str, horse_speed: int):
        if horse_type not in self.HORSE_NAME_OBJ:
            return
        self._validate_horse(self.horses, 'name', horse_name)
    ...
    def add_jockey(self, jockey_name: str, age: int):
        self._validate_jockey(self.jockeys, 'name', jockey_name)
        new_jockey = Jockey(jockey_name, age)
        self.jockeys.append(new_jockey)
        return f"Jockey {jockey_name} is added."

    def create_horse_race(self, race_type: str):
        self._validate_horse_race(self.horse_races, 'race_type', race_type)
        new_race = HorseRace(race_type)
        self.horse_races.append(new_race)
        return f"Race {race_type} is created."

    def add_horse_to_jockey(self, jockey_name: str, horse_type: str):
        jockey, horses = self._validate_add_horse_to_jockey(jockey_name, horse_type)
        if jockey.horse:
    ...
    def add_jockey_to_horse_race(self, race_type: str, jockey_name: str):
        horse_race, jockey = self._validate_add_jockey_to_horse_race(race_type, jockey_name)
    ...
    def start_horse_race(self, race_type: str):
        horse_race = self._validate_start_horse_race(race_type)
...
if __name__ == "__main__":
    ...
    print(horseRaceApp.create_horse_race("Autumn"))
